...
class MessageText:
    ...
    PICK_NEWSLETTER_CHAT = 'Напишите цифру чата который вам нужен. Если вам нужно выбрать более одного чата используйте такой формат: 1,2,3,4'
...
<b>Сообщение:</b>
    ...
    CHANNEL_PICKED_ERROR = 'Такой чат уже есть.'
    CANCELED = 'Отменено'
